...
class SkillPromotionService:
    ...
    def evaluate_skill_candidates(self, project: str, limit: int = 10) -> dict:
        try:
            return self._evaluate_skill_candidates_impl(project, limit)
    ...
    def _evaluate_skill_candidates_impl(self, project: str, limit: int = 10) -> dict:
        # Load registry
